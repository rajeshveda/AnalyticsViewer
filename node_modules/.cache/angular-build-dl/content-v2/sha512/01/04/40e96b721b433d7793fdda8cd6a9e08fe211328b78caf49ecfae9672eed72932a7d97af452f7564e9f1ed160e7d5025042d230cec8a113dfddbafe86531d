...
const routes = [
    ...
    {
        path: 'form',
        loadChildren: () => __webpack_require__.e(/*! import() | login-form-login-form-component */ "login-form-login-form-component").then(__webpack_require__.bind(null, /*! ./login-form/login-form.component */ "./src/app/login-form/login-form.component.ts")).then(m => m.LoginFormComponent)
    },
    {
        path: 'login',
...
module.exports = __webpack_require__(/*! /Users/rajeshna/Documents/Roar/tabs/src/main.ts */"./src/main.ts");
